        ...
        >
            <div className="w-full space-y-6 lg:w-auto sm:text-center">
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-300 text-start lg:max-w-2xl">
                    Somos un grupo destinado a cumplir la función de nexo entre una persona con problemas y una empresa dispuesta a solucionarlos. Si necesitás ayuda contactanos y te brindaremos atención personalizada para que puedas encontrar la solución adecuada a tus necesidades. Si queres formar parte de nuestro círculo de prestadores podes contactarnos via mail, whatsapp o mediante nuestras redes. Para más información, hace click aquí  <img src="https://i.postimg.cc/bNzQ1r7b/arrow.webp" alt="flecha hacia abajo" className='h-[1rem] rotate-[270deg] inline mx-2' />
                </p>
            </div>
