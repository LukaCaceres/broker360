            ...
            <div className="conocenos-page text-white">
                    ...
                    <div className="container mx-auto px-6 flex flex-col md:flex-row items-center">
                        <div className="xl:w-1/2 mr-4 text-pretty">
                            ...
                            <div className="xl:hidden my-6">
                                <img src="https://i.postimg.cc/y8xcr5Y8/sales-team.webp" alt="Equipo de ventas" className="rounded-2xl shadow-md" />
                            </div>
                            <p className="text-lg">
                ...
                <section className="our-mission py-16">
                    <div className="container mx-auto px-6">
                        ...
                        <img src="https://i.postimg.cc/wv8NMj51/shakinghand.webp" alt="Personas haciendo negocios" className="mx-auto rounded-2xl shadow-md xl:h-[35rem]" />
                    </div>
                </section>
                ...
                <section className="team-section py-16">
                    <div className="container mx-auto text-center">
                        ...
                        <div className="team-member">
                            <img src="https://i.postimg.cc/qMj2w0rF/CEO.webp" alt="imagen del CEO" className="rounded-full mx-auto mb-4 w-48 h-48 object-cover shadow-lg" />
